...
from presentation_maker.data_objects import Presentation, Topic, LAYOUT, Slide
from presentation_maker.presentation_genrating_stage.presentation_generation import \
    GenerationHandler, Organizer
from presentation_maker.templates import TEMPLATE
from presentation_maker.utils import RESULTS_DIR, divide_sentence
from presentation_maker.utils.PresentationExportionUtils import replace_with_image, \
    CONTENT_PLACEHOLDER_IDX, NUM_OF_LINES_PER_SLIDE, estimate_line_count, get_font_size
